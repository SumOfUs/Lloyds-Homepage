    ...
    <div className="w-full white-grey-bg">
      <div className="max-w-1440 3xl:mx-auto flex biglg:flex-row flex-col mx-8">
        <div className="biglg:w-1/2 3xl:pr-24 2xl:pr-16 lg:pr-16 py-8">
          <h1 className="primary-black text-6xl">The Problem</h1>
          <h3 className="primary-extra-bold text-5xl mb-6 leading-tight">
            Insuring and investing in climate destruction
          </h3>
          <p className="primary-medium text-2xl text-gray-900 leading-tight">
        ...
        <div className="biglg:w-1/2 3xl:pl-24 2xl:pl-16 lg:pl-8 py-8">
          <h1 className="primary-black text-6xl">The Solution</h1>
          <h3 className="primary-extra-bold text-5xl mb-6 leading-tight tracking-tight">
